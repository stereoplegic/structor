...
gulp.task('clean-server-dev', function(){
    return del(['/Users/ipselon/Development/projects/structor/test-release/node_modules/structor/server'], {force: true});
});
...
gulp.task('build-server-dev', ['clean-server-dev'], function() {
    return gulp.src('../src-server/**/*.js')
        .pipe(babel())
        .pipe(gulp.dest('/Users/ipselon/Development/projects/structor/test-release/node_modules/structor/server'));
});
